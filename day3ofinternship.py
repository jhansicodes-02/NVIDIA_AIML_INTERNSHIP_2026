...
Original file is located at
    https://colab.research.google.com/drive/1JQjf5QRuhWk8g0CYgS3SFHmOmdkcwOIq
"""
...
plt.plot(X_grid, lin_reg.predict(X_grid), color='red', label='Linear Best Fit Line')
plt.plot(X_grid, svr_lin.predict(X_grid), color='blue', linestyle='--', label='SVM Best Fit Line')
plt.legend()
